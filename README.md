...
To install squid proxy, run the script

```
wget https://raw.githubusercontent.com/pir8g33k/squid-proxy-automation/master/squid3-install.sh
...
```
wget https://raw.githubusercontent.com/pir8g33k/squid-proxy-automation/master/squid-conf-ip.sh
